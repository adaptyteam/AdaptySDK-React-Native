...
const adapty_identify_params_1 = require("./coders/adapty-identify-params");
...
class Adapty {
    ...
    activate(apiKey, params = {}) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const enableMock = (_a = params.__enableMock) !== null && _a !== void 0 ? _a : (0, utils_1.shouldEnableMock)();
            if (enableMock) {
                (0, bridge_1.initBridge)(enableMock, params.__mockConfig);
            }
    ...
    identify(customerUserId, params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const identifyParamsCoder = new adapty_identify_params_1.AdaptyIdentifyParamsCoder();
