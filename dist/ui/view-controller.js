...
class ViewController {
    ...
    static create(paywall, params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const paywallCoder = factory_1.coderFactory.createPaywallCoder();
            const paramsCoder = factory_1.coderFactory.createUiCreatePaywallViewParamsCoder();
            ...
            view.id = result.id;
            view.viewEmitter = new view_emitter_1.ViewEmitter(result.id);
    ...
    showDialog(config) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const coder = factory_1.coderFactory.createUiDialogConfigCoder();
