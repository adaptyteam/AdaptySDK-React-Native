...
export declare function getErrorCode(error: (typeof ErrorCode)[ErrorCode]): ErrorCode | undefined;
export declare function getErrorPrompt(code: ErrorCode): (typeof ErrorCode)[ErrorCode];
