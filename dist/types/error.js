...
exports.getErrorPrompt = exports.getErrorCode = exports.ErrorCode = void 0;
...
function getErrorCode(error) {
    const errorCode = Object.keys(exports.ErrorCode).find(keyStr => {
        const key = Number(keyStr);
        return exports.ErrorCode[key] === error;
    });
    if (!errorCode) {
        return undefined;
    }
...
function getErrorPrompt(code) {
    const prompt = exports.ErrorCode[code];
    if (!prompt) {
