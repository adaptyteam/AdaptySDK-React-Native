...
export const IOS_PAYWALL_PURCHASE_COMPLETED_SUCCESS = {
  ...
  product: {
    ...
    localized_description: "1 Year Premium Description",
    localized_title: "1 Year Premium",
    payload_data: "eyJjdXJyZW5jeV9jb2RlIjoiVVNEIiwicHJpY2VfYW1vdW50X21pY3JvcyI6Njk5OTAwMCwic3Vic2NyaXB0aW9uX2RhdGEiOnsiZ3JvdXBfaWRlbnRpZmllciI6IjIwNzcwNTc2Iiwib2ZmZXJfaWRlbnRpZmllciI6bnVsbH0sInR5cGUiOiJzdWJzIn0=",
    paywall_ab_test_name: "rt.Short.Overlay.Video.DarkMode.Toggle2 (Copy)",
    paywall_name: "rt.Short.Overlay.Video.DarkMode.Toggle2 (Copy)",
    price: {
      amount: 69.99,
  ...
  purchased_result: {
    type: "success",
    apple_jws_transaction: "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsImtpZCI6IjEyMzQ1Njc4OTAifQ.eyJpc3MiOiJodHRwczovL2FwcGxlaWQuYXBwbGUuY29tIiwiZXhwIjoxNzM1Mjg4MDAwLCJpYXQiOjE3MzUyODQ0MDAsImp0aSI6IjEyMzQ1Njc4OTAtYWJjZGVmZ2hpamsifQ.signature",
    profile: {
      paid_access_levels: {
        premium: {
