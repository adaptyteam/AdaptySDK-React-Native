...
export const PAYWALL_PURCHASE_COMPLETED_SUCCESS = {
  ...
  product: {
    ...
    web_purchase_url: "http://paywalls-14c3d623-2f3a-455a-aa86-ef83dff6913b.fnlfx.com/trest2",
    paywall_product_index: 0,
    adapty_product_id: "b136422f-8153-402a-afbb-986929c68f6a"
  },
  purchased_result: {
    type: "success",
    google_purchase_token: "abcdefghijklmnopqrs.AO-J1Oy0BKdJa02G4rK5G7jxhSbdajFmsy3FSHTqLUwE1rApPKMSJaY_gZg6aIVgxPO10_GRD94ZCSKvoAp3EkqDLRLQ45W7-Q",
    profile: {
      paid_access_levels: {
        premium: {
...
export const PAYWALL_RESTORE_FAILED = {
  ...
  error: {
    adapty_code: 103,
    message: "Play Market request failed: Billing service unavailable on device."
  },
...
export const PAYWALL_RENDERING_FAILED = {
  ...
  error: {
    adapty_code: 23,
    message: "The paywall JSON is not valid. Fix it in the Adapty Dashboard. Refer to the Customize paywall with remote config topic for details on how to fix it."
  },
